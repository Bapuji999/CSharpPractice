...
namespace Project5.Migrations
{
    ...
    [Migration("20231220055916_Customer Intrest added")]
    partial class CustomerIntrestadded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Project5.Models.CustomerIntrest", b =>
                {
            ...
            modelBuilder.Entity("Project5.Models.CustomerIntrest", b =>
                {
                    b.HasOne("Project5.Models.User", "Customer")
                        .WithMany("CustomerIntrests")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Project5.Models.Product", "Product")
                        .WithMany("CustomerIntrests")
